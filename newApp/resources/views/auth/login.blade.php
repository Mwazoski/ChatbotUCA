...
<div class="overlay" style="position: absolute; top: 50%; position: fixed; left: 50%; 
                            min-width: 100%; min-height: 100%; width: auto; height: auto; transform: translateX(-50%) translateY(-50%);
                            z-index: 0; background: url('imagenes/p2.jpg');">
</div>
...
">Nombre de Usuario</label>
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-12 col-form-label text-md-left" style="font-weight: bold; font-size: 16px;text-transform: capitalize;}">Contraseña</label>
